...
public class GravelLargeSpreaderProcedure {
	public static void execute(LevelAccessor world, double x, double z) {
		...
		for (int index0 = 0; index0 < 13; index0++) {
			...
			for (int index1 = 0; index1 < 13; index1++) {
				...
				} else if (Math.random() < 0.45 && (world.getBlockState(BlockPos.containing(x + sx, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + sx), (int) (z + sz)) - 1, z + sz))).getBlock() == Blocks.GRASS_BLOCK) {
					world.setBlock(BlockPos.containing(x + sx, world.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (int) (x + sx), (int) (z + sz)) - 1, z + sz), Blocks.GRAVEL.defaultBlockState(), 3);
				}
				sz = sz + 1;
			}
